...
TeamsUserCredential.prototype.getToken = async (scopes: string | string[], options?: any) => {
  const accessToken: AccessToken = {
    // Function extension will check the expiration time of the token, so set it to a large number.
    // It will check the azp claim of the token, so set it to a valid value. It should be contained in the ALLOWED_APP_IDS in teamsapp.local.yml.
